from ipyDatumTron import atum, datum, katum, Of, Intersect, Union 
from ipyDatumTron import ExtensionMethods
import clr
clr.ImportExtensions(ExtensionMethods)
